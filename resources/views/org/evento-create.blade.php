            ...
            <div class="col-md-10 col-lg-8">
                ...
                <form action="{{ route('org.evento.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <label for="img_input" class="w-100" style="cursor: pointer">
                            <div class="upload-box p-4 rounded border d-flex flex-column align-items-center justify-content-center"
                                style="min-height: 160px; background-color: rgba(255,255,255,0.02); border-style: dashed !important; border-color: rgba(255,255,255,0.15);">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-sm-4">
                            <label class="form-label small fw-bold text-uppercase text-white mb-1">Capacidade Máxima (Pessoas/Inscritos):</label>
                            <input type="number" name="max_capacity" class="form-control form-white-input" 
                                placeholder="Ex: 500" min="1" value="{{ old('max_capacity') }}" required>
                            @error('max_capacity')
                                <span class="text-danger small mt-1 d-block">{{ $message }}</span>
                            @enderror
                        </div>
