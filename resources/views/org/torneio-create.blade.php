                ...
                <form action="{{ route('org.torneio.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="number" step="0.01" min="0" name="entrance_fee" class="form-control form-white-input"
                                   placeholder="0.00 (Deixe 0 para Grátis)" value="0.00" required>
                        </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-4">
                            <label class="form-label small fw-bold text-uppercase text-white mb-1">Limite de Inscrição:</label>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-6">
                            <label class="form-label small fw-bold text-uppercase text-white mb-1">Horário de Início das Partidas:</label>
                            <input type="time" name="start_time" class="form-control form-white-input" required>
                        </div>

                        <div class="col-sm-6">
                            <label class="form-label small fw-bold text-uppercase text-white mb-1">Horário Estimado de Término:</label>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="description" class="form-control textarea-custom" rows="5"
                                  placeholder="Regras específicas, formato de chaves (MD1, MD3), canais de comunicação (Discord), etc..." required></textarea>
                    </div>
