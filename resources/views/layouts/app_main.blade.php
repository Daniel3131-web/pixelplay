        ...
        <aside class="d-flex flex-column p-3 text-white sidebar border-end border-dark shadow">
            ...
            <nav class="nav flex-column gap-1 mb-auto pt-2">
                <a href="{{ route('org.dashboard') }}"
                    class="nav-link-custom @if(request()->routeIs('org.dashboard')) active @endif">
                ...
                <a href="{{ route('player.times') }}"
                    class="nav-link-custom @if(request()->routeIs('player.times*')) active @endif">
                ...
                @if(Auth::user()->team_id)
                    <a href="{{ route('player.time.show', Auth::user()->team_id) }}"
                        class="nav-link-custom @if(request()->is('time/' . Auth::user()->team_id)) active @endif">
            ...
            <div class="dropdown border-top border-secondary pt-3 mt-auto">
                <a href="#"
                    class="d-flex align-items-center text-white text-decoration-none dropdown-toggle px-2 py-2 rounded-3 user-dropdown-toggle transition"
                    data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="position-relative me-2">
                        @if (Auth::user()->img)
                            <img src="{{ Auth::user()->img }}"
                                class="rounded-circle d-flex align-items-center justify-content-center fw-bold border border-2 border-primary"
                                style="width: 38px; height: 38px;" alt="Foto de Perfil">
                        @else
                    ...
                    <div class="d-flex flex-column text-start lh-sm">
                        ...
                        <span class="text-white-50 small text-uppercase fw-bold"
                            style="font-size: 0.65rem; letter-spacing: 0.5px;">Organizador</span>
                    </div>
                </a>
        ...
        <main class="py-4 px-3 px-md-5">
            ...
            @if (session('msg'))
                <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 1060;">
                    <div id="systemToast" class="toast align-items-center text-white bg-dark border-0 shadow-lg" role="alert"
        ...
        <aside class="d-flex flex-column p-3 text-white sidebar border-end border-dark shadow">
            ...
            <nav class="nav flex-column gap-1 mb-auto pt-2">
                 <a href="{{ route('player.torneios') }}"
                    class="nav-link-custom @if(request()->routeIs('player.torneios')) active @endif">
            ...
            <div class="dropdown border-top border-secondary pt-3 mt-auto">
                ...
                <ul class="dropdown-menu dropdown-menu-white dropdown-menu-end shadow-lg border-secondary pb-2"
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('profile.edit') }}">
                            <i class="bi bi-cash text-muted fs-5"></i>
