...
@section('content')
    ...
    @php
        $isTournament = isset($tournamentId);
        $inputName = $isTournament ? 'tournament_id' : 'event_id';
        $inputValue = $isTournament ? $tournamentId : ($eventId ?? null);
    @endphp
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <form action="{{ route('payment.process') }}" method="POST" id="paymentForm"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="metodo" id="paymentMethod" class="form-select form-white-input"
                        ...
                        <div id="cardFields" style="display: none;">
                            <input type="text" id="cardNumber" class="form-control mb-2 form-white-input"
                                placeholder="Número do Cartão (16 dígitos)" maxlength="19" oninput="formatCard(this)">
                            <div class="row">
                                <div class="col-6"><input type="text" class="form-control mb-2 form-white-input"
                                        placeholder="MM/AA" maxlength="5"></div>
                                <div class="col-6"><input type="text" class="form-control mb-2 form-white-input"
                                        placeholder="CVV" maxlength="3"></div>
                            </div>
                            <div id="cardError" class="text-danger small mb-2" style="display: none;">Número de cartão inválido.
                            </div>
                        </div>
